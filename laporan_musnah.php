...
<body>
        ...
        <table border="0" align="center" width="100%">
            ...
            <font size="5"><b><u> berita acara</u></b></font><br>
            <font align="center" size="3">Pada hari ini …………… tanggal …………… bulan ……………. Tahun …………..
            yang bertandatangan di bawah ini, berdasarkan persetujuan ……………. Telah memusnahkan
            arsip sejumlah ………………. Sebagaimana tercantum dalam Daftar terlampir
           </font><br>
        </div>
        <br>
        <br>
...
$ambilsemuadatastok = mysqli_query($conn, "select * from pemusnahan
                INNER JOIN stock on pemusnahan.idbarang = stock.idbarang where tanggal between '$tgl_a' and '$tgl_s'");
